...
/**
 * Tests all methods related to the Model English Solitaire class.
 */
public class EnglishSolitaireModelTest {

  EnglishSolitaireModel model1;
  EnglishSolitaireModel model2;
  EnglishSolitaireModel model22;
  EnglishSolitaireModel model3;
  EnglishSolitaireModel model32;
  EnglishSolitaireModel model4;
  EnglishSolitaireModel model42;

  @Before
  public void setup() {
    model1 = new EnglishSolitaireModel();
    model2 = new EnglishSolitaireModel(3);
    model22 = new EnglishSolitaireModel(5);
    model3 = new EnglishSolitaireModel(3, 3);
    model32 = new EnglishSolitaireModel(6, 4);
    model4 = new EnglishSolitaireModel(3, 3, 3);
    model42 = new EnglishSolitaireModel(5, 3, 8);
  }
  ...
  public void testConstructor2Exception() {
    assertEquals(10, new EnglishSolitaireModel(4).getBoardSize());
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructor2Exception2() {
    assertEquals(10, new EnglishSolitaireModel(6).getBoardSize());
  }
  ...
  public void testConstructor3Exception() {
    assertEquals(10, new EnglishSolitaireModel(7, 5).getBoardSize());
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructor3Exception2() {
    assertEquals(10, new EnglishSolitaireModel(-1, -5).getBoardSize());
  }
  ...
  public void testConstructor4Exception() {
    assertEquals(10, new EnglishSolitaireModel(3, -1, 3).getBoardSize());
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructor4Exception2() {
    assertEquals(10, new EnglishSolitaireModel(3, 3, -3).getBoardSize());
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructor4Exception3() {
    assertEquals(10, new EnglishSolitaireModel(6, 3, 3).getBoardSize());
  }
  ...
  public void testGetBoardSize() {
    ...
    assertEquals(7, new EnglishSolitaireModel(3, 3).getBoardSize());
    assertEquals(7, new EnglishSolitaireModel(3, 3, 3).getBoardSize());
  ...
  public void testMove() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            model1.getSlotAt(1, 3));//down move
  ...
  public void testNoFromMarbleException() {
    model1.move(3, 3, 1, 3);//if from has a marble
  }


  @Test(expected = IllegalArgumentException.class)
  public void testToNotEmptyException() {
    model1.move(2, 2, 2, 4);//if to isn't empty
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNoBetweenException() {
    model1.move(3, 2, 3, 4);//If there is no marble between them
  }
  ...
  public void testGetScore() {
    ...
    model1.move(3, 1, 3, 3);
    assertEquals(29, this.model1.getScore());
    model1.move(6, 3, 4, 3);
